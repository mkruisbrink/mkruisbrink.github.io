...
You can install the tidyverse via **`install.packages("tidyverse")`** and you only have to install it once. You can load it afterwards...
...
#### ggplot2 examples
A few simple illustrations of how to create graphs with ggplot. There is no code from other packages present. I'll implement more of the code from other packages in other examples.
