...
![tidyverse](/img/icons/r-packages/thumbs/tidyverse.png)

You can install the tidyverse via **`install.packages("tidyverse")`**
and you only have to install it once. After…
...
![tidyverse](/img/icons/r-packages/thumbs/ggplot2.png)
...
care of the details. [Go to docs…](https://ggplot2.tidyverse.org/)

``` r
library(tidyverse) #loads ggplot 
```

![tidyverse](/img/icons/r-packages/thumbs/dplyr.png)
...
![tidyverse](/img/icons/r-packages/thumbs/tidyr.png)
...
![tidyverse](/img/icons/r-packages/thumbs/readr.png)
...
![tidyverse](/img/icons/r-packages/thumbs/purrr.png)
...
![tidyverse](/img/icons/r-packages/thumbs/tibble.png)
...
![tidyverse](/img/icons/r-packages/thumbs/stringr.png)
...
![tidyverse](/img/icons/r-packages/thumbs/forcats.png)
