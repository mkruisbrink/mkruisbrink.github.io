...
<figure class="img-center">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-demo-1.webp" title="R Project Demo" alt="R Project Demo">
</figure>
...
<figure class="img-center">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/pane3-environment.webp" title="R Environment Pane" alt="R Environment Pane">
</figure>
...
<figure class="img-center">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/pane4-explorer.webp" title="R Explorer Pane" alt="R Explorer Pane">
</figure>
...
1. You open a blank file for an R script by selecting *New File* ![New File](/assets/icons/r-studio/new-file-rstudio.png){: .icon} at the top-left and then selecting *R Script* ![R Script](/assets/icons/r-studio/R-script-rstudio.png){: .icon}
2. Select the *File* menu and click the *R Script* ![R Script](/assets/icons/r-studio/R-script-rstudio.png){: .icon} option.
...
* In the top-left of your screen, click on *Create a project* ![New R Project](/assets/icons/r-studio/new-project-rstudio.png){: .icon}
* Or go to the *File* menu and select the *New Project...* option
* The New Project Wizard opens

<figure class="centered">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-1.webp" title="R Project" alt="R Project">
</figure>
...
<figure class="centered">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-5-existing-directory.webp" title="R Project Existing Directory" alt="R Project Existing Directory">
</figure>
...
<figure class="half">
    <a href="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-2.webp"><img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-2.webp" alt="Project type"></a>
    <a href="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-3.webp"><img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-3.webp" alt="Project name"></a>
</figure>
...
<figure class="img-center">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-4.webp" title="New R Project" alt="New R Project">
</figure>
...
<figure class="centered">
    <img src="/assets/images/posts/2022-08-09-RStudio-introduction/R-project-file-explorer.webp" title="New R Project" alt="New R Project">
</figure>
...
* To run these lines of code you can use the *Run* ![Run](/assets/icons/r-studio/run-script-rstudio.png){: .icon} command (`<CTRL> + <Enter>`). This will run the current line or selection.
* If you want to run the entire script, select everything with `<CTRL> + <A>` and then press either `<CTRL> + <Enter>` or click the *Run* ![Run](/assets/icons/r-studio/run-script-rstudio.png){: .icon} command after you made the selection.
